...
@section('title', 'Stellar HTML Demo - Sign in')
                ...
                <div class="cprys c95ga cxhtj cecgn c2iur">
                    <div class="cyi18 cxnez cspj9 cy2wm">
                        ...
                        <div class="ce08t c3blx cecgn cspj9">
                            ...
                            <!-- Page title -->
                            <h1 class="cy4g8 cz1f5 cl10g c8yrn c10r8 cmck1 c2pml">Sign in to your account</h1>
                        </div>
                        ...
                        <div class="cdzd8 cecgn">
                            ...
                            <form>
                                <div class="cmxj2">
                                    <div>
                                        <label class="c1yjy cveoa czlc0 csowg cryyo" for="email">Email</label>
                                        <input id="email" class="c17oc c1621" type="email" required="">
                                    </div>
                                    <div>
                                        <div class="ck9br c96dl">
                                            <label class="c1yjy cveoa czlc0 csowg cryyo" for="password">Password</label>
                                            <a class="cgncf cp8n5 cxkpk cveoa cy2w0 c0h1x czlc0 cn2l5" href="reset-password.html">Forgot?</a>
                                        </div>
                                ...
                                <div class="c6ax2">
                                    <button class="ckcj1 c5rr4 c5zoy cbhty czlc0 c1621 c474f cnp54">
                                        Sign In <span class="c0lwy c1ogz cg4ou chkot cxkpk cy2w0 caz78">-&gt;</span>
                                    </button>
                                </div>
                            </form>
                            ...
                            <div class="ce08t c83bg">
                                <div class="c3pte czlc0">
                                    Don't have an account? <a class="cgncf cp8n5 cxkpk cveoa cy2w0 c0h1x" href="signup.html">Sign up</a>
                                </div>
                            </div>
...
<!-- Mirrored from preview.cruip.com/stellar/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Oct 2024 19:24:35 GMT -->
</html>